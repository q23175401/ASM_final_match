...
del ASM_FIANL.lst	REM ASM_FIANL可以替換成.asm檔的檔名
del ASM_FIANL.obj
del ASM_FIANL.ilk
del ASM_FIANL.pdb
del ASM_FIANL.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:ASM_FIANL.exe ASM_FIANL.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
